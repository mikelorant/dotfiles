# Generated by Powerlevel10k configuration wizard on 2020-06-26 at 16:13 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_UPDATE_ON_COMMAND=true # false
  # Custom icon.
  ...
  function p10k-on-pre-prompt()  {
    if [[ $PWD != ${POWERLEVEL9K_CD_PWD:=$PWD} ]]; then
      POWERLEVEL9K_CD_CARRIAGE_RETURN="\r"
      ...
      echo "$POWERLEVEL9K_CD_CARRIAGE_RETURN$POWERLEVEL9K_CD_PREFIX $POWERLEVEL9K_CD_RESULT"
  ...
  # really need it.
  typeset -g POWERLEVEL9K_DISABLE_HOT_RELOAD=false # true
